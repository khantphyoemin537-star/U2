...
# ==========================================
BULK_IMPORT_DELAY_SECONDS = 3  # gap between every message checked — safe even for a channel
# with many thousands of "added new Character" posts spread across a full day.
