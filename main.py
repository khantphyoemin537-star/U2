...
POWER_RANGER_COLLECTIONS = [
    ...
    "ninja_col",  # 🥷 same 31 ninja sessions, reused by /nsync + /syncfromcatch_parallel
]
...
# already talks to catch_bot (see _nsync_detect_target_username) — no guessing needed.
